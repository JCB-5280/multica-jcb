...
var rootHelpTemplate = `Work seamlessly with MATO from the command line.

USAGE
  mato <command> <subcommand> [flags]
{{range .Groups}}
{{.Title}}
...
EXAMPLES
  ...
  $ mato daemon start
  $ mato agent list --output json

ENVIRONMENT VARIABLES
  MATO_SERVER_URL    Override the default server URL
  MATO_WORKSPACE_ID  Set the active workspace

LEARN MORE
  Use ` + "`mato <command> <subcommand> --help`" + ` for more information about a command.
`
