...
var rootCmd = &cobra.Command{
	Use:   "mato",
	Short: "MATO CLI — local agent runtime and management tool",
	Long:  "Work seamlessly with MATO from the command line.",
	SilenceUsage:  true,
	SilenceErrors: true,
}
...
func init() {
	...
	rootCmd.SetVersionTemplate("mato {{.Version}}\n")
	...
	rootCmd.PersistentFlags().String("server-url", "", "MATO server URL (env: MATO_SERVER_URL)")
	rootCmd.PersistentFlags().String("workspace-id", "", "Workspace ID (env: MATO_WORKSPACE_ID)")
