...
import (
	...
	"github.com/mato-ai/mato/server/internal/mention"
...
// `mato issue create` call. Pre-validates that the agent is reachable
...
// manual `mato agent update <id> --status idle` to unwedge. Matches the
...
// daemon-injected MATO_QUICK_CREATE_TASK_ID env var, so this lookup is
