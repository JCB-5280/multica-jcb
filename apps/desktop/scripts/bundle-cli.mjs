#!/usr/bin/env node
// Builds the `mato` CLI from server/cmd/mato and copies the binary
...
//
// ldflags mirror `make build` so `mato --version` reports a meaningful
// version / commit / date.
//
...
function binaryNameForPlatform(platform) {
  return platform === "win32" ? "mato.exe" : "mato";
}
