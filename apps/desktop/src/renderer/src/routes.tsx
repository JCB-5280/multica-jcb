...
import { ProjectsPage } from "@mato/views/projects/components";
import { DashboardPage } from "@mato/views/dashboard";
import { AutopilotsPage } from "@mato/views/autopilots/components";
import { MyIssuesPage } from "@mato/views/my-issues";
import { SkillsPage } from "@mato/views/skills";
import { FilesPage } from "@mato/views/files";
import { DesktopRuntimesPage } from "./components/desktop-runtimes-page";
import { AgentsPage } from "@mato/views/agents";
import { SquadsPage, SquadDetailPage as SquadDetailPageView } from "@mato/views/squads/components";
import { InboxPage } from "@mato/views/inbox";
import { SettingsPage } from "@mato/views/settings";
    ...
    children: [
      { index: true, element: null },
      {
        ...
        children: [
          ...
          { path: "files", element: <FilesPage />, handle: { title: "Files" } },
