...
// Docs-local stateless MATO mark — matches @mato/ui's MATOIcon
...
// desktop). Leading icon = brand identity (GitHub mark / MATO asterisk);
...
export const baseOptions: BaseLayoutProps = {
  nav: {
    title: (
      <span className="font-semibold text-base">MATO Docs</span>
    ),
  },
  links: [
    {
