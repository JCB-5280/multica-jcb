---
title: CLI Reference
description: Complete command reference for the MATO CLI and agent daemon.
---
...
When connecting to a self-hosted MATO instance, point the CLI to your server before logging in:
