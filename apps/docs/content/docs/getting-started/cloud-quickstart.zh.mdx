...
description: Get started with MATO Cloud — no setup required.
---

The fastest way to get started with MATO — no setup required.

## 1. Sign up

Go to [mato.ai](https://mato.ai) and create an account.
