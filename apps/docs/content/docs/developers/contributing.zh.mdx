---
title: Contributing
description: Local development workflow for contributors working on the MATO codebase.
---
...
| | Main | Worktree |
|---|---|---|
| Database | `mato` | `mato_my_feature_702` |
...
```bash
docker compose exec -T postgres psql -U mato -d postgres \
