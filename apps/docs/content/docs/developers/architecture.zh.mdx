---
title: Architecture
description: Technical architecture of the MATO platform.
---

## Overview

MATO is a Go backend + monorepo frontend (pnpm workspaces + Turborepo) with shared packages.
...
- **Entry points** (`cmd/`): `server` (HTTP API), `mato` (CLI + daemon), `migrate`
