...
export const metadata: Metadata = {
  title: "Download MATO",
  description:
    "Download MATO for macOS, Windows, or Linux — or install the CLI for servers and remote dev boxes.",
  openGraph: {
    title: "Download MATO",
    description:
      "Get the MATO desktop app with a bundled daemon, or install the CLI for servers and remote dev boxes.",
    url: "/download",
  },
  alternates: {
    canonical: "/download",
