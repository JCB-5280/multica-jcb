...
import { createBrowserCookieLocaleAdapter } from "@mato/core/i18n/browser";
import type { LocaleResources, SupportedLocale } from "@mato/core/i18n";
...
// cookie mode on their next logout/login cycle (logout clears mato_token).
// Sunset: once telemetry shows <1% of sessions still carry mato_token,
...
function hasLegacyToken(): boolean {
  ...
  try {
    return Boolean(window.localStorage.getItem("mato_token"));
  } catch {
    return false;
  }
}
