...
const SAMPLE_LATEST_ASSET = {
  name: "mato-desktop-0.2.14-mac-arm64.dmg",
  browser_download_url:
    "https://github.com/mato-ai/mato/releases/download/v0.2.14/mato-desktop-0.2.14-mac-arm64.dmg",
};

const SAMPLE_PREV_ASSET = {
  name: "mato-desktop-0.2.13-mac-arm64.dmg",
  browser_download_url:
    "https://github.com/mato-ai/mato/releases/download/v0.2.13/mato-desktop-0.2.13-mac-arm64.dmg",
};
...
function releasePayload(overrides: {
  ...
  return {
    ...
    html_url: `https://github.com/mato-ai/mato/releases/tag/${overrides.tag}`,
