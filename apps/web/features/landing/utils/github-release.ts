...
/**
 * Server-side fetcher for the latest MATO release, designed to
...
const GITHUB_RELEASES_URL =
  "https://api.github.com/repos/mato-ai/mato/releases?per_page=2";
...
export async function fetchLatestRelease(): Promise<LatestRelease> {
  ...
  try {
    ...
    // Defensive filter — MATO doesn't publish prereleases or drafts
