...
postgres_db="mato_${slug}_${offset}"
postgres_port=5432
...
DATABASE_URL=postgres://mato:mato@localhost:${postgres_port}/${postgres_db}?sslmode=disable

PORT=${backend_port}
JWT_SECRET=change-me-in-production
MATO_DEV_VERIFICATION_CODE=888888
MATO_SERVER_URL=ws://localhost:${backend_port}/ws
