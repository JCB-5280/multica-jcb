...
const DB = process.env.DATABASE_URL || "postgres://mato:mato@localhost:5432/mato_mato_101?sslmode=disable";
...
async function main() {
  ...
  await page.evaluate((t) => localStorage.setItem("mato_token", t), token);
