...
const AGENT_STORAGE_KEY = "mato:chat:selectedAgentId";
const SESSION_STORAGE_KEY = "mato:chat:activeSessionId";
/** Drafts are stored as one JSON blob per workspace: { [sessionId]: text }. */
const DRAFTS_KEY = "mato:chat:drafts";
/** Placeholder sessionId for a chat that hasn't been created yet. */
export const DRAFT_NEW_SESSION = "__new__";
const CHAT_WIDTH_KEY = "mato:chat:width";
const CHAT_HEIGHT_KEY = "mato:chat:height";
const CHAT_EXPANDED_KEY = "mato:chat:expanded";
/** Focus mode is a personal preference — global across workspaces/sessions. */
const FOCUS_MODE_KEY = "mato:chat:focusMode";
/**
 ...
 */
const OPEN_KEY = "mato:chat:isOpen";
