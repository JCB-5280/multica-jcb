 ...
 *
 * Uses exact hostname match against `cdnDomain` (e.g. "mato-static.copilothub.ai"),
 ...
 * @param cdnDomain CDN hostname for legacy link detection (e.g. "mato-static.copilothub.ai")
 */
