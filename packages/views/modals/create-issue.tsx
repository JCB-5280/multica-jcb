...
import type { Issue, IssueStatus, IssuePriority, IssueAssigneeType } from "@mato/core/types";
import {
  DialogContent,
  DialogTitle,
...
import { useCreateModeStore } from "@mato/core/issues/stores/create-mode-store";
import { useQuickCreateStore } from "@mato/core/issues/stores/quick-create-store";
import { issueDetailOptions } from "@mato/core/issues/queries";
import { useCreateIssue, useUpdateIssue } from "@mato/core/issues/mutations";
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const shouldShowBacklogHint =
        ...
        localStorage.getItem("mato:backlog-agent-hint-dismissed") !== "true";
        ...
        {backlogHintIssueId ? (
          <BacklogAgentHintContent
            ...
            onDismissPermanently={() => {
              localStorage.setItem("mato:backlog-agent-hint-dismissed", "true");
            }}
            onMoveToTodo={() => {
...
import { Dialog as DialogRoot } from "@mato/ui/components/ui/dialog";
