...
vi.mock("@mato/core/issues/queries", () => ({
...
vi.mock("@mato/core/issues/stores/draft-store", () => ({
...
vi.mock("@mato/core/issues/stores/quick-create-store", () => ({
  useQuickCreateStore: (selector?: (state: typeof mockQuickCreateStore) => unknown) =>
    (selector ? selector(mockQuickCreateStore) : mockQuickCreateStore),
}));

vi.mock("@mato/core/issues/mutations", () => ({
...
vi.mock("@mato/ui/components/ui/switch", () => ({
  Switch: ({
    checked,
    onCheckedChange,
  }: {
...
vi.mock("@mato/ui/components/common/file-upload-button", () => ({
