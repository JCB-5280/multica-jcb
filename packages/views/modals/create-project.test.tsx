...
const longRepoUrl =
  "https://github.com/mato.ai/a-very-long-repository-name-that-needs-a-tooltip";

vi.mock("@tanstack/react-query", () => ({
  useQuery: () => ({ data: [] }),
}));

vi.mock("@mato/core/projects/mutations", () => ({
  useCreateProject: () => ({ mutateAsync: vi.fn() }),
}));

vi.mock("@mato/core/projects", () => ({
...
vi.mock("@mato/ui/components/common/emoji-picker", () => ({
  EmojiPicker: () => null,
}));
