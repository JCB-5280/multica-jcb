...
import type { AgentRuntime } from "@mato/core/types";
...
function CliWaitingStatus({ dialogOpen }: { dialogOpen: boolean }) {
  ...
  // Stage thresholds are rough — `mato setup` typical flow is
      ...
      >
        {stage === "normal" && (
          <>
            ...
            <span className="font-mono">{"mato setup"}</span>
