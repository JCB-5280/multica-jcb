...
} from "@mato/core/inbox/mutations";
...
import type { InboxItem } from "@mato/core/types";
import { Button } from "@mato/ui/components/ui/button";
import {
  ResizablePanelGroup,
  ResizablePanel,
  ResizableHandle,
} from "@mato/ui/components/ui/resizable";
  ...
  const detailContent = selected?.issue_id ? (
    ...
    <ErrorBoundary resetKeys={[selected.issue_id]}>
      <IssueDetail
        ...
        layoutId="mato_inbox_issue_detail_layout"
