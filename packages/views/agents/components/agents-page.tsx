...
import type { Agent, AgentRuntime, CreateAgentRequest } from "@mato/core/types";
import {
...
import { useAgentsViewStore } from "@mato/core/agents/stores";
    ...
    <PageHeader className="justify-between px-5">
      <div className="flex items-center gap-2">
        ...
        <p className="ml-2 hidden text-xs text-muted-foreground md:block">
          {t(($) => $.page.tagline)}{" "}
          <a
            href="https://mato.ai/docs/agents"
            target="_blank"
