...
import type { GitHubPullRequest } from "@mato/core/types";
import enCommon from "../../locales/en/common.json";
import enIssues from "../../locales/en/issues.json";

const TEST_RESOURCES = { en: { common: enCommon, issues: enIssues } };

vi.mock("@mato/core/github/queries", async () => {
  const actual = await vi.importActual<typeof import("@mato/core/github/queries")>(
    "@mato/core/github/queries",
  );
  return {
    ...actual,
