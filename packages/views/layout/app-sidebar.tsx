...
import { Collapsible, CollapsibleTrigger, CollapsibleContent } from "@mato/ui/components/ui/collapsible";
import { StatusIcon } from "../issues/components/status-icon";
import { useIssueDraftStore } from "@mato/core/issues/stores/draft-store";
import { openCreateIssueWithPreference } from "@mato/core/issues/stores/create-mode-store";
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
  ...
  SidebarMenuItem,
  SidebarRail,
} from "@mato/ui/components/ui/sidebar";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuGroup,
...
import { useCurrentWorkspace, useWorkspacePaths, paths } from "@mato/core/paths";
import { workspaceListOptions, myInvitationListOptions, workspaceKeys } from "@mato/core/workspace/queries";
import { useQuery, useMutation, useQueryClient } from "@tanstack/react-query";
import { inboxKeys, deduplicateInboxItems } from "@mato/core/inbox/queries";
import { api, ApiError } from "@mato/core/api";
import { useModalStore } from "@mato/core/modals";
import { useMyRuntimesNeedUpdate } from "@mato/core/runtimes/hooks";
import { pinListOptions } from "@mato/core/pins/queries";
import { useDeletePin, useReorderPins } from "@mato/core/pins/mutations";
import { issueDetailOptions } from "@mato/core/issues/queries";
import { projectDetailOptions } from "@mato/core/projects/queries";
import type { PinnedItem } from "@mato/core/types";
